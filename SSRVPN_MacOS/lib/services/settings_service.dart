...
class SettingsService extends ChangeNotifier {
  ...
  Future<String?> _readDefaultApiSecret() => _privateFileStore.readApiSecret();

  Future<void> _writeDefaultApiSecret(String value) =>
      _privateFileStore.writeApiSecret(value);

  void _syncDataDirectory() => _privateFileStore.syncDataDirectory();

  Future<void> _removeApiSecretTemporaryFiles() =>
      _privateFileStore.removeApiSecretTemporaryFiles();
  ...
  Future<void> _ensurePrivateDataDirectory(String path) =>
      _privateFileStore.ensurePrivateDataDirectory(path);
