...
class IpGeoService {
  ...
  Future<(String flag, String code)?> lookupFlagByIp(String ipOrDomain) async {
    ...
    _runningCount--;
    _processQueue();
    return result != null ? (_flagEmoji(result.countryCode), result.countryCode) : null;
  }
  ...
  String? _extractServerFromName(String name) {
    ...
    // 尝试提取看起来像域名后缀的模式
    final domainPattern = RegExp(r'\b([a-zA-Z0-9][-a-zA-Z0-9]*\.)+[a-zA-Z]{2,}\b');
  ...
  String? _localCountryCode(String name) {
    ...
    const keywordMap = {
      '美国': 'US', '洛杉矶': 'US', '圣何塞': 'US', '纽约': 'US', '西雅图': 'US',
      '硅谷': 'US', '达拉斯': 'US', '芝加哥': 'US', '迈阿密': 'US', '凤凰城': 'US',
      'USA': 'US', 'AMERICA': 'US', 'US ': 'US',
      '日本': 'JP', '东京': 'JP', '大阪': 'JP', 'JAPAN': 'JP', 'JP ': 'JP',
      '韩国': 'KR', '首尔': 'KR', 'KOREA': 'KR', 'KR ': 'KR', 'SOUTH KOREA': 'KR',
      '香港': 'HK', 'HONG KONG': 'HK', 'HK ': 'HK',
      '台湾': 'TW', '台北': 'TW', 'TAIWAN': 'TW', 'TW ': 'TW',
      '新加坡': 'SG', 'SINGAPORE': 'SG', 'SG ': 'SG',
      '德国': 'DE', '法兰克福': 'DE', 'GERMANY': 'DE', 'DE ': 'DE',
      '法国': 'FR', '巴黎': 'FR', 'FRANCE': 'FR', 'FR ': 'FR',
      '荷兰': 'NL', 'NETHERLANDS': 'NL', 'NL ': 'NL',
      '加拿大': 'CA', 'CANADA': 'CA', 'CA ': 'CA',
      '澳大利亚': 'AU', '悉尼': 'AU', 'AUSTRALIA': 'AU', 'AU ': 'AU',
      '印度': 'IN', '孟买': 'IN', 'INDIA': 'IN', 'IN ': 'IN',
      '泰国': 'TH', '曼谷': 'TH', 'THAILAND': 'TH', 'TH ': 'TH',
      '越南': 'VN', '胡志明': 'VN', 'VIETNAM': 'VN',
      '印度尼西亚': 'ID', '雅加达': 'ID', 'INDONESIA': 'ID',
      '菲律宾': 'PH', '马尼拉': 'PH', 'PHILIPPINES': 'PH',
      '马来西亚': 'MY', '吉隆坡': 'MY', 'MALAYSIA': 'MY', 'MY ': 'MY',
      '俄罗斯': 'RU', '莫斯科': 'RU', 'RUSSIA': 'RU', 'RU ': 'RU',
      '土耳其': 'TR', '伊斯坦布尔': 'TR', 'TURKEY': 'TR',
      '巴西': 'BR', 'BRAZIL': 'BR', 'BR ': 'BR',
      '阿根廷': 'AR', 'ARGENTINA': 'AR',
      '墨西哥': 'MX', 'MEXICO': 'MX',
      '英国': 'GB', '伦敦': 'GB', 'UK ': 'GB', 'UNITED KINGDOM': 'GB',
      '意大利': 'IT', 'ITALY': 'IT',
