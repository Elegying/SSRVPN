...
> **历史快照。** 本文只记录 `v3.4.0` 发布前后的审查证据，不能证明后续版本已完成
> Windows 11 L4 真机矩阵。2026-07-16 的深度复核另发现并修复了跨 VPN 路由误判、桌面
> OSS 更新清单缺少独立摘要背书、验证入口漂移和当前文档过期等问题；当前状态以
> [项目健康状态](../PROJECT_HEALTH.md) 为准。
