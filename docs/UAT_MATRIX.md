...
2026-09-06 审查修复、Mac 与 USB Android 真实节点验证及 Windows 待验收清单，统一见
[本轮验收报告](uat/SSRVPN_审查修复与实机验收_20260906.md)。以下按日期保留的旧版本记录
只代表对应历史候选，不代替本轮设备证据。应用版本仍为 v4.0.34，源码修复未发布。
