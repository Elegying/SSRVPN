...
## 2026-09-01 v4.0.19 本地发布证据边界

- 完整脱敏报告见 [`docs/uat/SSRVPN_v4.0.19_三端发布证据_20260901.md`](uat/SSRVPN_v4.0.19_三端发布证据_20260901.md)。
...
- 本轮无 macOS 主机和 Android 真机。macOS 授权/DNS/长离线取消及 Android VPN 授权/后台恢复/原生 16 KiB page-size/OEM 后台限制全部保持 `blocked`；自动化和包结构证据不替代真机。
