...
## 2026-08-22 v4.0.15 发布候选证据边界

- 本版本触达三端连接健康/恢复、Android VPN 生命周期、Windows 内置更新与安装器，以及三端“关于/使用教程”界面；因此不能只引用旧版本绿色 CI 作为发布结论。
...
- “私家车”节点固定 24–39 ms 显示规则和桌面订阅卡片只通过长按/右键编辑的既定交互未修改。
