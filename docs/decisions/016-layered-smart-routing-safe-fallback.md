...
部分被 [ADR-017](017-independent-routing-channel.md) 取代（应用分流、更新通道和优先级），其 IPv4-only 边界与首条「IPv6 拒绝」层被
[ADR-018](018-dual-stack-routing.md) 取代；历史决策已接受（2026-09-02），2026-09-03 按 Android 国内应用可用性和低流量规则更新修订；取代
