...
void main() {
    ...
    // Outside the geometry texture there is no glass. Clamping first extends
    // its edge texels into the capture draw margin, leaving vertical streaks.
    if (any(lessThan(geometryUV, vec2(0.0))) ||
