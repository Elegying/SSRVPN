  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        Positioned.fill(
          child: CustomPaint(painter: _LiquidBackdropPainter(isDark: isDark)),
        ),
        child,
      ],
    );
                          ...
                          colors: isDark
                              ? [
                                  ...
                                  AppTheme.primary.withValues(
                                    alpha: darkLiftAlpha * 0.22,
                                  ),
                                  AppTheme.accentColor.withValues(
                                    alpha: darkLiftAlpha * 0.12,
                                  ),
                                ]
                              : [
